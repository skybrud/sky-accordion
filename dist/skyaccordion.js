...
exports.default = {
	install: function install(Vue, options) {
		var _Object$assign = (0, _assign2.default)({}, defaults, options),
		    ...
		    accordionDefaults = _Object$assign.accordionDefaults;

		if (registerComponents) {
			Vue.component(_SkyAccordion2.default.name, (0, _assign2.default)({}, _SkyAccordion2.default, {
				computed: {
					config: function config() {
						return (0, _assign2.default)({}, accordionDefaults, this.options);
					}
				}
			}));
		}
...
Component.options.__file = "/Users/mhelmuth/Sites/mhelmuth/skybrud/sky-accordion/src/SkyAccordion.vue"
...
var _SkyAccordionStore = __webpack_require__(47);

var _SkyAccordionStore2 = _interopRequireDefault(_SkyAccordionStore);
...
exports.default = {
	...
	computed: {
		config: function config() {
			return (0, _assign2.default)({}, this.options);
		}
	},
	beforeMount: function beforeMount() {
		...
		_SkyAccordionStore2.default.add(this);
	},
	...
	beforeDestroy: function beforeDestroy() {
		_SkyAccordionStore2.default.remove(this);
	},
	...
	methods: {
		...
		toggle: function toggle(bool) {
			this.isOpen = typeof bool === 'boolean' ? bool : !this.isOpen;

			if (this.config.closeOthersOnOpen && this.isOpen) {
				_SkyAccordionStore2.default.toggleAll(false, [this]);
			}
...
var SkyAccordionStore = new _vue2.default({
	data: function data() {
		return {
			accordions: []
		};
	...
	methods: {
		...
		toggleAll: function toggleAll(bool) {
			...
			this.accordions.filter(function (acc) {
				return exclude.indexOf(acc) === -1;
...
exports.default = SkyAccordionStore;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._t("title")], 2), _vm._v(" "), _c('SkyReveal', {
    attrs: {
      "open": _vm.isOpen
    }
  }, [_c('div', {
    staticClass: "sky-accordion-content"
  }, [_vm._t("default")], 2)])], 1)
},staticRenderFns: []}
